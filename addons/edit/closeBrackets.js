        ...
        map['\'' + left + '\''] = function(cm) {
          ...
          for (var i = 0; i < ranges.length; i++) {
            ...
            if (!range.empty()) {
              ...
              var _range = cm.getRange(cur, Pos(cur.line, cur.ch + 3));
              // TODO: is there any reason this can't be 3 * left?
              if (_range === left + left + left) {
                curType = 'skipThree';
              } else {
                curType = 'skip';
              }
          ...
          cm.operation(function() {
            ...
            if (type === 'skip') {
              ...
              for (i = 0; i < 3; i++) { cm.execCommand('goCharRight'); }
